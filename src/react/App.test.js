...
describe("App component", () => {
  ...
  it("Render tasks List with all tasks", async () => {
    ...
    expect(screen.queryByText("not done task")).toBeInTheDocument();
  });
  ...
  it("Render only active tasks", async () => {
    ...
    expect(screen.queryByTestId(/tasks-list/i)).toBeInTheDocument();
  ...
  it("Render empty list", async () => {
    ...
    expect(screen.queryByText(/Not have tasks/i)).toBeInTheDocument();
  });
  ...
  it("Edit task => content", async () => {
    ...
    expect(screen.queryByText(/was edited/i)).toBeInTheDocument();
  });
  ...
  it("Delete task", async () => {
    ...
    await waitForElementToBeRemoved(() => screen.getByText("Task fro delete"));
